...
var row, col = 0, 0
var pairs = [][]string{
{"fiona/gary", "gary/ian", "ian/james", "james/kyle", "kyle/leila", "leila/mheni", "mheni/nadia", "nadia/fiona"},
{"fiona/ian", "gary/james", "ian/kyle", "james/leila", "kyle/mheni", "leila/nadia", "mheni/fiona", "nadia/gary"},
{"fiona/james", "gary/kyle", "ian/leila", "james/mheni", "kyle/nadia", "leila/fiona", "mheni/gary", "nadia/ian"},
{"fiona/kyle", "gary/leila", "ian/mheni", "james/nadia", "kyle/fiona", "leila/gary", "mheni/james", "nadia/james"},
{"fiona/leila", "gary/mheni", "ian/nadia", "james/fiona", "kyle/gary", "leila/james", "mheni/ian", "nadia/kyle"},
{"fiona/mheni", "gary/nadia", "ian/fiona", "james/gary", "kyle/james", "leila/ian", "mheni/kyle", "nadia/leila"},
{"fiona/nadia", "gary/fiona", "ian/gary", "james/james", "kyle/ian", "leila/kyle", "mheni/leila", "nadia/mheni"},
 } // endpairs.
...
func main() {
  ...
  switch cmap["cmd"] {
    ...
    case "Autotest":
      for ix:= 0; true; ix++ {
        cmdarray := Autoconstructor(cmap["throttle"], correspondent)
...
func Autoconstructor(throt string, crosp string) []string {
  cmds := []string{}
  ...
  for ix := 0; ix < thrut; ix++ {
    sender, receiver := ReturnPair(thrut)
...
func ReturnPair(userct int) (string, string) {
  senrec := strings.Split(pairs[row][col], string("/"))
    sen := fmt.Sprintf("users2/%s.conf", senrec[0])
    rec := fmt.Sprintf("users2/%s.pub", senrec[1])
  col += 1
  if col == userct {
    col = 0; row += 1
    if row == (userct - 1) { row = 0 }
  }
  return sen, rec
} // end func ReturnPair.
